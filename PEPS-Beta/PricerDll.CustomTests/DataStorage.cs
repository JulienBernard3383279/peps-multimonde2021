...
namespace PricerDll.CustomTests
{
    public class DataStorage
    {
        ...
        public void FillData()
        {
            ...
            asx = dr.ReadCSVData(Path.Combine(System.IO.Directory.GetCurrentDirectory(), @"..\..\..\..\DataFiYa\ASX.csv"), 0, 5);
            // CAC 40 //
            // uncomment if needed
            //cac = dr.ReadCSVData(Path.Combine(System.IO.Directory.GetCurrentDirectory(), @"..\..\.\..\DataFiYa\CAC40.csv"),0,5);

            estox = dr.ReadCSVData(Path.Combine(System.IO.Directory.GetCurrentDirectory(), @"..\..\..\..\DataFiYa\ESTOXX50.csv"), 0, 5);
            ftse = dr.ReadCSVData(Path.Combine(System.IO.Directory.GetCurrentDirectory(), @"..\..\..\..\DataFiYa\FTSE100.csv"), 1, 5);
            sp500 = dr.ReadCSVData(Path.Combine(System.IO.Directory.GetCurrentDirectory(), @"..\..\..\..\DataFiYa\SP500.csv"), 0, 5);
            n225 = dr.ReadCSVData(Path.Combine(System.IO.Directory.GetCurrentDirectory(), @"..\..\..\..\DataFiYa\n225.csv"), 0, 5);

            hang = dr.ReadCSVData(Path.Combine(System.IO.Directory.GetCurrentDirectory(), @"..\..\..\..\DataFiYa\HANG.csv"), 0, 5);
